...
from mmdet.ops import ConvModule, ConvModule_BIN,ConvModule_BIN_OFFLINE
from ..registry import NECKS


@NECKS.register_module
class FPN_TEST(nn.Module):
    """
    ...
    def __init__(self,
        ...
        if add_extra_convs and extra_levels >= 1:
            for i in range(extra_levels):
                ...
                extra_fpn_conv = ConvModule_TEST(
                    in_channels,
                    out_channels,
                    3,
                    stride=2,
